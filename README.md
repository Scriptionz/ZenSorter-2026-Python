...
> Features
- **Duplicate Protection:** Automatically renames files if they already exist in the target folder.
- **Safety Prompt:** Asks for user confirmation before starting.
- **Reporting:** Generates a detailed `ZenSorter_Summary.txt` report.
- **Developer Friendly:** Supports over 30+ file extensions out of the box.
